'''
Layers for graph transformer

Adapted from Dwivedi & Bresson DLG-AAAI'21
REF for code: https://github.com/graphdeeplearning/graphtransformer/
'''
...
class MultiHeadAttentionLayer_with_e(nn.Module):
    def __init__(self, in_dim, out_dim, num_heads, use_bias):
        super().__init__()
...
class GraphTransformerLayer_with_e(nn.Module):
    """
        Param: 
    """
    def __init__(self, in_dim, out_dim, num_heads, dropout=0.0, layer_norm=False, batch_norm=True, residual=True, use_bias=False):
        ...
        self.attention = MultiHeadAttentionLayer_with_e(in_dim, out_dim//num_heads, num_heads, use_bias)
